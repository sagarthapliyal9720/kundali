        ...
        <div className="max-w-5xl mx-auto bg-[#1e1038]/90 border border-[#c9922a] rounded-3xl shadow-xl overflow-hidden relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-10">
              ...
              {/* Inject global style to fix native date/time picker icon color */}
              <style>{`
                input[type="date"]::-webkit-calendar-picker-indicator,
                input[type="time"]::-webkit-calendar-picker-indicator {
                  filter: invert(65%) sepia(60%) saturate(500%) hue-rotate(5deg) brightness(95%);
                  cursor: pointer;
                }
              `}</style>
                ...
                <div>
                  ...
                  <div className="flex items-center border border-[#5b4779] bg-[#140b27] rounded-xl px-4 focus-within:border-[#c9922a] transition">
                    ...
                    <input
                      ...
                      value={formData.dob}
                      onChange={handleChange}
                      className="w-full px-4 py-3 outline-none bg-transparent text-[#f0e6c8] [color-scheme:dark]"
                      required
                    />
                  </div>
                </div>
