...
export default function Kundli() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://127.0.0.1:8000/kundali/generate/",
        payload,
        {
          headers: {
  ...
  {/* Main Card */}
  <div className="max-w-4xl mx-auto bg-[#1e1038]/90 border border-[#c9922a] rounded-3xl shadow-xl overflow-hidden relative z-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="bg-[#140b27] text-[#f0e6c8] p-10 flex flex-col justify-center border-r border-[#5b4779]">
        ...
        <h2 className="text-4xl font-bold leading-tight text-[#f0e6c8]">
          Discover Your
          <br />
          Cosmic Journey ✨
        </h2>
        ...
        <div className="mt-10 space-y-4">
          ...
          <div className="bg-[#1e1038] border border-[#5b4779] rounded-xl p-4 text-[#f0e6c8]">
