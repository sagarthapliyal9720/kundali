...
export default function Birthchart() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#160d28] flex flex-col justify-center items-center gap-4 p-6">

      {/* Heading */}
      <div className="text-center">
        <h1 className="text-xl font-medium text-[#f0e6c8] tracking-wide">Lagna Chart</h1>
        <p className="text-xs text-[#8b7aa0] mt-1">D1 · Janma Kundali · Lahiri Ayanamsa</p>
      </div>
      ...
      <div className="relative w-[520px] h-[520px] bg-[#1e1038] border-2 border-[#c9922a] overflow-hidden rounded-md">
        ...
        >
          <rect x="0" y="0" width="100" height="100" fill="none" stroke="#c9922a" strokeWidth="0.4" />
